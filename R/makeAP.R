...
#'   
#' @details makeAP (make aerial plan) creates flight control files for the
#'    3DR Solo/PixHawk flightcontroller. The PixHawk flightcontroller files are using the MAVLINK
#'   common message set, that is used by the PixHawk flight controller family.
#'   PixHawk flightcontroller/3DR Solo:\cr The open uav community is focused
...
#' @param cameraType currently you can choose GP3_7MP GP3_11MP and MAPIR2
