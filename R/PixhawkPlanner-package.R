#' The package provides some mission planning functionality for dealing with Unmanned Aerial Vehicles based on the Pixhawk flightcontroller family
#'
#' @description The package provides some mission planning functionality for dealing with Unmanned Aerial Vehicles. The focus is set on an easy to use workflow for planning autonomous obstacle avoiding surveys of rtf-UAVs to retrieve aerial or spot related data. It provides flight control files 
#' based on the MAVlink protocol. Additionally it contains some useful tools for digitizing and data manipulation.
...
#' @name PixhawkPlanner
#' @docType package
#' @title Pixhawk UAV Mission Planner
#' @author Chris Reudenbach Hanna Meyer Marvin Ludwig
#' \cr
